  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="editorial-eyebrow">Room photo board</p>
          <h2 className="editorial-display mt-3 text-[1.8rem] leading-none text-primary">
            Visual context
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-on-surface-variant">
            Keep the uploaded room images visible here while the agent extracts mood, objects, and
      ...
      {attachments.length === 0 ? (
        <div className="relative mt-6 min-h-[22rem] overflow-hidden rounded-[28px] bg-[color:var(--surface-container-low)] p-6">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[minmax(0,1.28fr)_minmax(240px,0.72fr)]">
          <button
          ...
          >
            ...
            <div className="absolute bottom-5 left-5 rounded-[22px] bg-[rgba(255,255,255,0.92)] px-4 py-3 shadow-[var(--panel-shadow)]">
              <p className="editorial-eyebrow">Primary reference</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            {attachments.slice(1).map((attachment) => (
              ...
              >
                ...
                <div className="px-4 py-3">
                  <p className="editorial-eyebrow">Supporting angle</p>
                  <p className="mt-2 text-sm font-semibold text-primary">
            ...
            {attachments.length === 1 ? (
              <div className="rounded-[24px] bg-[color:var(--surface-container-low)] px-4 py-5 shadow-[var(--panel-shadow)]">
                <p className="editorial-eyebrow">Next step</p>
