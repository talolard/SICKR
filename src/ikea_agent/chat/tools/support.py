"""Shared helpers for chat agent tool registration."""
...
def telemetry_context(ctx: RunContext[ChatAgentDeps]) -> dict[str, str | None]:
    """Return stable trace context fields for chat-tool logs."""
...
def floor_plan_repository(ctx: RunContext[ChatAgentDeps]) -> FloorPlanRepository | None:
...
def analysis_repository(ctx: RunContext[ChatAgentDeps]) -> AnalysisRepository | None:
...
def search_repository(ctx: RunContext[ChatAgentDeps]) -> SearchRepository | None:
...
def room_3d_repository(ctx: RunContext[ChatAgentDeps]) -> Room3DRepository | None:
