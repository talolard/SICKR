...
_DEFAULT_PROMPT_TEMPLATES: tuple[_PromptTemplateSeed, ...] = (
    _PromptTemplateSeed(
        ...
        template_text=(
            ...
            "- items: list of recommended canonical_product_key values and reasons\n"
            "\n"
            "Rules:\n"
            "1) Use only product keys from the candidate list.\n"
            ...
            'Candidate keys: {{ product_keys|join:", " }}\n'
            "\n"
            "Return JSON only."
        ),
    ),
    _PromptTemplateSeed(
        ...
        template_text=(
            ...
            "3) Select 2-4 items max from candidate keys.\n"
            "4) Never return keys not in the provided candidate list.\n"
            "\n"
            "User query: {{ user_query }}\n"
            'Candidate keys: {{ product_keys|join:", " }}\n'
            "\n"
    ...
    _PromptTemplateSeed(
        ...
        template_text=(
            ...
            "4) Select only from candidate keys.\n"
            "\n"
            "User query: {{ user_query }}\n"
            'Candidate keys: {{ product_keys|join:", " }}\n'
            "\n"
