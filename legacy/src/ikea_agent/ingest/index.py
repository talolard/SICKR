...
from ikea_agent.ingest.embedding_client import (
    EmbeddingClientConfig,
    VertexGeminiEmbeddingClient,
)
from ikea_agent.ingest.repository import IndexRepository
...
from ikea_agent.shared.types import EmbeddedVectorRow
