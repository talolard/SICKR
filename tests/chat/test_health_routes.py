...
def test_schema_check_for_sqlite_reports_missing_tables(tmp_path: Any) -> None:
...
def test_schema_check_for_sqlite_reports_ready_tables(tmp_path: Any) -> None:
...
def test_seed_state_check_reports_unready_systems(tmp_path: Any) -> None:
...
def test_readiness_payload_handles_connection_failures() -> None:
    ...
    status_code, payload = _readiness_payload(cast(Any, _BrokenEngine()))
