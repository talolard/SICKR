...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("analysis_id", "ordinal", name="uq_analysis_input_assets_ordinal"),
        sa.UniqueConstraint("analysis_id", "asset_id", name="uq_analysis_input_assets_asset_id"),
        schema=APP_SCHEMA,
    )
    op.create_index(
