"""Add durable revealed preference memory table.
...
def upgrade() -> None:
    """Create thread-scoped durable revealed preference memory."""
...
def downgrade() -> None:
    """Drop durable revealed preference memory."""
    ...
    op.drop_table("revealed_preferences", schema=APP_SCHEMA)
