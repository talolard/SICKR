"""Capture live search-agent runs for fixture authoring and review."""
...
from evals.search import SearchAgentEvalHarness, build_search_eval_dataset
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Capture live search-agent eval runs.")
    parser.add_argument(
        "--case",
        action="append",
        dest="case_names",
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("tmp/search-eval-captures"),
            ...
            index.append(
                {
                    ...
                    "fixture_name": case.inputs.fixture_name,
                    "source_thread_id": case.inputs.source_thread_id,
                }
            )
